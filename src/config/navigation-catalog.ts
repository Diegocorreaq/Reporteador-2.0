...
const navigationCatalogBase: CatalogResource[] = [
  ...
  {
    id: 'main-mama-canguro',
    title: 'Mamá Canguro',
    description: 'Dashboard Power BI del programa Mamá Canguro.',
    workspace: 'principal',
    workspaceLabel: 'Reporteador',
    type: 'tablero',
    category: 'Neonatología',
    route: '/app/neonatologia/mama-canguro',
    breadcrumb: 'Reporteador → Neonatología',
    aliases: ['mama canguro', 'madre canguro', 'neonatologia'],
    keywords: ['mama', 'canguro', 'neonatologia', 'prematuro', 'tablero', 'powerbi'],
    permissionKey: 'menu.main.neonatologia.mama-canguro',
  },
  {
    id: 'main-piel-a-piel',
    title: 'Piel a Piel',
    description: 'Dashboard Power BI del programa Piel a Piel.',
    workspace: 'principal',
    workspaceLabel: 'Reporteador',
    type: 'tablero',
    category: 'Neonatología',
    route: '/app/neonatologia/piel-a-piel',
    breadcrumb: 'Reporteador → Neonatología',
    aliases: ['piel a piel', 'contacto piel a piel', 'neonatologia'],
    keywords: ['piel', 'contacto', 'neonatologia', 'recien nacido', 'tablero', 'powerbi'],
    permissionKey: 'menu.main.neonatologia.piel-a-piel',
  },
